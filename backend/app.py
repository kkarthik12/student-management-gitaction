...
# MongoDB connection — now points to Cosmos DB's Mongo API connection string
MONGO_URI = os.environ["MONGO_URI"]  # no local default anymore — must be set
...
def search_students():
    ...
    return jsonify([serialize_doc(student) for student in students])
# NEW: serve the built React frontend for everything else
